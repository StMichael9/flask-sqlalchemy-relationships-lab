...
class Event(db.Model):
    ...
    sessions = db.relationship('Session',cascade='all, delete-orphan', back_populates = 'event')
...
class Speaker(db.Model):
    ...
    bio = db.relationship('Bio', uselist=False, cascade='all, delete-orphan', back_populates = 'speaker' )
